      ...
      <section id="contact-section">
        <div className="container links-container">
          ...
          <div className="contact-container">
            ...
            <a href="https://www.instagram.com/felixsunphoto/" className="contact-link" target="_blank"><i className="fa fa-instagram" aria-hidden="true"></i> www.instagram.com/felixsunphoto</a>
            <a href="felix-resume.pdf" className="contact-link" target="_blank"><i className="fa fa-file-pdf-o" aria-hidden="true"></i> Download Resume</a>
          </div>
        </div>
        <footer>
